...
$sql = "SELECT id, razon_social COLLATE utf8mb4_unicode_ci AS razon_social, rfc COLLATE utf8mb4_unicode_ci AS rfc, fecha_registro, 'Cliente' AS tipo FROM clients_form 
        UNION ALL 
        SELECT id, razon_social COLLATE utf8mb4_unicode_ci AS razon_social, rfc COLLATE utf8mb4_unicode_ci AS rfc, fecha_registro, 'Proveedor' AS tipo FROM providers_form 
